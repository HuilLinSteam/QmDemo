    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						{"menuid":"1","icon":"","menuname":"教学管理",
							"menus":[
									{"menuid":"11","menuname":"成绩查询","icon":"icon-find","url":"StudentAction-toExamStudentView"},
								]
						},
						{"menuid":"2","icon":"","menuname":"班级信息",
							"menus":[
									{"menuid":"21","menuname":"班级通讯录","icon":"icon-note","url":"StudentAction-toStudentNoteListView"},
								]
						},
						{"menuid":"3","icon":"","menuname":"系统管理",
							"menus":[
							        {"menuid":"31","menuname":"个人信息","icon":"icon-password","url":"StudentAction-toPersonal"},
								]
						}
				]};
